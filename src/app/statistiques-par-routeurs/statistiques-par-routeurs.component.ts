        ...
        this.service
            ...
            .subscribe(
                (resp:any) => {
                    ...
                    this.messageService.add({severity:'success', summary:'Statistiques par Routeurs', detail:'Filtrage effectué avec succès !'});
                    this.showLoader = false;
                },
                (error) => { 
                    this.messageService.add({severity:'error', summary:'Statistiques par Routeurs', detail:'Une erreur est survenue durant le filtrage !'});
                    this.showLoader = false;
                },
            );
    }
    ...
    getPagedDataAsync(pageSize, page) {
        ...
        this.service
            ...
            .subscribe(
                ...
                (error) => { 
                    this.showLoader = false;
                    this.messageService.add({severity:'error', summary:'Statistiques par Routeurs', detail:'Une erreur est survenue durant la récupération des données !'});
                },
            );
    }
