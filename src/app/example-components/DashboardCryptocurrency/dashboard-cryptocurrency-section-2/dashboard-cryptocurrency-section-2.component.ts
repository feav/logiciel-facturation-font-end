...
@Component({
  selector: 'app-dashboard-cryptocurrency-section-2',
  templateUrl: './dashboard-cryptocurrency-section-2.component.html',
})
export class DashboardCryptocurrencySection2Component {
