...
@Component({
  selector: 'app-dashboard-crm-manager-section-2',
  templateUrl: './dashboard-crm-manager-section-2.component.html',
})
export class DashboardCrmManagerSection2Component {
