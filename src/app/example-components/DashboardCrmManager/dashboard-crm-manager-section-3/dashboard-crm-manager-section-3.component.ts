...
@Component({
  selector: 'app-dashboard-crm-manager-section-3',
  templateUrl: './dashboard-crm-manager-section-3.component.html',
})
export class DashboardCrmManagerSection3Component {
