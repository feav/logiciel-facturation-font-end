...
@Component({
  selector: 'app-dashboard-server-status-section-6',
  templateUrl: './dashboard-server-status-section-6.component.html',
})
export class DashboardServerStatusSection6Component {
