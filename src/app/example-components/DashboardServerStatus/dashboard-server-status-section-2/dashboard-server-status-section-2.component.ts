...
@Component({
  selector: 'app-dashboard-server-status-section-2',
  templateUrl: './dashboard-server-status-section-2.component.html',
})
export class DashboardServerStatusSection2Component {
