...
@Component({
  selector: 'app-progress-bars-dynamic-circles-variations',
  templateUrl: './progress-bars-dynamic-circles-variations.component.html',
})
export class ProgressBarsDynamicCirclesVariationsComponent implements OnInit, OnDestroy {
