...
@Component({
  selector: 'app-dashboard-real-estate-section-2',
  templateUrl: './dashboard-real-estate-section-2.component.html',
})

export class DashboardRealEstateSection2Component {
